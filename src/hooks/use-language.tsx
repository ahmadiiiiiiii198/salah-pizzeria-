...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    // Hero section
    "pizzeriaName": "Efes Kebap",
    "pizzeriaLocation": "Torino",
    "heroSubtitle": "Autentico Kebap Turco e Pizza Italiana",
    "heroDescription": "Autentico kebap turco e pizza italiana nel cuore di Torino",
  ...
  en: {
    ...
    "heroSubtitle": "Authentic Turkish Kebap & Italian Pizza",
    "heroDescription": "Authentic Turkish kebap and Italian pizza in the heart of Turin",
  ...
  const setLanguage = (lang: Language) => {
    ...
    if (savedSettings) {
      try {
        ...
        localStorage.setItem('restaurantSettings', JSON.stringify(parsedSettings));
      } catch (e) {
