...
const Ordini = () => {
  ...
  return (
    <AuthenticatedAdminWrapper title="Gestione Ordini - Efes Kebap" showLogout={false}>
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
          ...
          <div className="flex items-center justify-between md:hidden">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Efes Kebap</p>
              </div>
            </div>
          ...
          <div className="hidden md:flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 font-medium">Efes Kebap</p>
        ...
        <div className="px-3 sm:px-6 py-3 sm:py-4">
          ...
          <div className="hidden md:flex items-center justify-between text-sm text-gray-600">
            <div className="flex items-center space-x-2">
              ...
              <span>Efes Kebap - Sistema di Gestione Ordini</span>
            </div>
            <div className="flex items-center space-x-4">
      ...
      {/* Unified Notification System - SINGLE INSTANCE for entire app */}
      <Suspense fallback={
