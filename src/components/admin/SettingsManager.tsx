...
const SettingsManager = () => {
  ...
  const [settings, setSettings] = useState<RestaurantSettings>({
    restaurant_name: 'Efes Kebap Torino',
    address: 'C.so Giulio Cesare, 36, 10152 Torino TO',
    phone: '+393479190907',
    email: 'info@efeskebap.it',
    website: 'https://efeskebap.it',
    delivery_fee: 3.50,
    minimum_order: 15.00,
    delivery_radius: 5,
    stripe_enabled: true,
    ...
    notification_email: 'orders@efeskebap.it',
    meta_title: 'Efes Kebap Torino - Autentico Kebap Turco e Pizza Italiana',
    meta_description: 'Efes Kebap a Torino offre autentico kebap turco e pizza italiana. Ordina online per consegna a domicilio o ritiro.',
    meta_keywords: 'kebap, ristorante, torino, consegna, turco, efes kebap'
  });
