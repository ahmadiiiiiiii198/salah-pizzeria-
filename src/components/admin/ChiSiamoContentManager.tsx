...
const DEFAULT_CONTENT: ChiSiamoContent = {
  it: {
    ...
    paragraph1: 'Efes Kebap nasce dalla passione per l\'autentica tradizione turca e italiana e dall\'esperienza culinaria tramandata nel tempo. Offriamo kebap turco e pizza italiana preparati con amore, ingredienti freschi e tecniche tradizionali.',
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="Tagline del ristorante"
          />
        </div>
