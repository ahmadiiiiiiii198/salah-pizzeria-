...
const OrderNotificationSystem = () => {
  ...
  const generateBellTone = (): string => {
    try {
      ...
      console.error('🔊 [OrderNotification] Error generating bell tone:', error);
  ...
  useEffect(() => {
    ...
    const initializeAudio = () => {
      try {
        ...
        // Use the generated pleasant bell tone instead of the old beep
        console.log('🔊 [OrderNotification] Using generated pleasant bell tone');
        ...
        audio.onerror = () => {
          console.log('🔊 [OrderNotification] Audio error, using generated pleasant bell tone fallback');
          ...
          const fallbackAudio = new Audio(generateBellTone());
          fallbackAudio.loop = true;
          fallbackAudio.volume = 0.8;

          audioRef.current = fallbackAudio;
          console.log('🔊 [OrderNotification] Fallback pleasant bell tone audio created');
        };
