...
async function addEfesKebapAdditionalMenu() {
  try {
    console.log('🍕 Starting Efes Kebap additional menu items addition...');

    // Step 1: Find or create PIZZE category
    console.log('📂 Finding PIZZE category...');
    ...
    console.log('📂 Finding EXTRA category...');
    ...
    console.log('📂 Finding DOLCI category...');
    ...
    console.log('🍕 Adding additional pizzas...');
    ...
    console.log('➕ Adding rinforzo extra...');
    ...
    console.log('\n🎉 Successfully added all Efes Kebap additional menu items!');
    console.log(`📊 Summary:`);
    ...
    console.error('❌ Error in addEfesKebapAdditionalMenu:', error);
  }
}
